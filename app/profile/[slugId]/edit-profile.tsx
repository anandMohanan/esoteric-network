        ...
        return (
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button variant="outline" className={primaryfont.className}>Edit Profile</Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader className={primaryfont.className}>
                        <DialogTitle>Edit profile</DialogTitle>
                        <DialogDescription className={secondaryfont.className}>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-6">
                            <div className="grid gap-4 py-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="grid grid-cols-4 items-center gap-4">
                                            <FormLabel htmlFor="username" className={cn("text-right", primaryfont.className)}>
                                                Username
                                            </FormLabel>
                                            <FormControl>
                                                <Input id="Username"
                                                    {...field}
                                                    className={cn("col-span-3", secondaryfont.className)} placeholder="Enter your username" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="grid grid-cols-4 items-center gap-4">
                                            <FormLabel htmlFor="bio" className={cn("text-right", primaryfont.className)}>
                                                Bio
                                            </FormLabel>
                                            <FormControl>
                                                <Input id="bio"
                                                    {...field}
                                                    className={cn("col-span-3", secondaryfont.className)} placeholder="Enter your bio" />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                            ...
                            <DialogFooter>
                                <Button type="submit" disabled={updateUserPending} className={primaryfont.className}>
